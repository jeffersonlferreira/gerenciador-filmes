<div class="w-full h-full flex justify-center items-center">
    <div class="flex flex-col gap-14 w-80">
        ...
        <div class="flex gap-1 items-center justify-center text-center text-[#7A7B9F] text-base p-1 bg-[#131320]">
            <a href="/login" class="w-1/2 px-2 py-1 border rounded h-10">Login</a>
            <a href="/register" class="w-1/2 px-2 py-1 border rounded h-10">Register</a>
        </div>
