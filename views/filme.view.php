<section class="flex w-full items-center gap-12">
    ...
    <img src="assets/image/Pobres_Criaturas.png" class="rounded-md w-[381px] h-[490px]">

    <div class="flex flex-col gap-5 items-start py-3 flex-1 self-stretch">

        <a href="#" class="flex items-center gap-2 py-4 text-[#7A7B9F]">
        ...
        <div class="flex flex-col justify-between items-start flex-1 self-stretch">
            ...
            <div>
                ...
                <div>
                    ...
                    <h1 class="font-['Rajdhani'] text-3xl font-bold text-[#E4E5EC]">Titulo do filme</h1>

                    <div>

                        <h2 class="text-[#B5B6C9]">Categoria: Animação</h2>
                        <h2 class="text-[#B5B6C9]">Ano: 2024</h2>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex items-center gap-2">
                            <h2 class="font-['Rajdhani'] text-2xl text-[#E4E5EC] font-bold">4</h2>
...
<section class="flex w-full flex-col items-start gap-10 pt-16">
    ...
    <div class="flex flex-col gap-3 items-start self-stretch">
        ...
        <!-- card -->
        <div class="bg-[#131320] flex p-8 items-start gap-12 self-stretch rounded-md">

            <div class="flex gap-4 items-center min-w-[216px]">
            ...
            <div class="flex items-center gap-1.5 p-2.5 h-8 bg-[#1A1B2D] rounded-md font-['Rajdhani']">
                <div class="flex items-baseline gap-0.5">
                    <p class="text-xl font-bold text-xl">4</p>
...
<div id="modal" class="fixed inset-0 flex items-center justify-center hidden bg-[#040407]/60 backdrop-blur-sm">
    <div class="w-[600px] h-[570px] bg-[#0F0F1A] border border-[#1A1B2D] rounded-2xl p-10 flex flex-col gap-8">

        <button class="flex justify-center items-center w-8 h-8 gap-3 absolute right-[42rem] top-[12rem] bg-[#1A1B2D] rounded-md" onclick="toggleModal()">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#7A7B9F" viewBox="0 0 256 256">
        ...
        <form class="flex flex-col gap-6 w-full">
            ...
            <div class="flex gap-8">
                ...
                <img src="assets/image/Pobres_Criaturas.png" class="w-[137px] h-[176px] rounded-md">

                <div class="flex flex-col justify-between">

                    <div class="flex flex-col gap-3">
                        <h3 class="font-[Rajdhani] font-bold text-2xl">Pobres Criaturas</h3>
